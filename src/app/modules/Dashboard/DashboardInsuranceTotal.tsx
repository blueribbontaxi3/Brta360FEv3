...
export const DashboardInsuranceTotal: React.FC = () => {
  ...
  const value = data?.currentPeriod
    ? data.currentPeriod.totalPremium
    : '-';
  ...
  return (
    <Card size="small" title="Insurance" extra={dayjs().subtract(1, 'year').format('YYYY') + ' / ' + dayjs().format('YYYY')}>
