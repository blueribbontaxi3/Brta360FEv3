...
const Discount = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'date',
      key: 'date',
      render: (_: any, record: any) => record.date,
    },
    {
      title: 'Amount',
      dataIndex: 'amount',
      ...
      render: (item: any, record: any) => {
        return (
          <Space direction="vertical">
            <Space wrap>
              {
                isPermission(authPermission, 'Discounts Update') &&

                <Button type="primary" icon={<EditOutlined />} onClick={() => handleUpdate(record)} />

              }
              {/* {
                isPermission(authPermission, 'Discounts Delete') &&
                <Popconfirm
                  title="Delete the affiliations"
                  description="Are you sure to delete this discounts?"
                  okText="Yes"
                  cancelText="No"
    ...
    <>
      ...
      <Card>
        <AdvanceTable
          ...
          onDelete={isPermission(authPermission, 'Discounts Delete') ? onDelete : ''}
        />
        <Popup {...popupProps} />
      </Card>
    </>
