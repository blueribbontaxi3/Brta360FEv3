...
const PaceProgramRate = () => {
  ...
  const confirm: any = (item: any) => {
    ...
    axios.delete(`/pace-program-rates`, {
      data: {
        ids: dataArray
      }
    }).then((r) => {
      ...
      render: (item: any, record: any) => {
        return (
          <Space direction="vertical">
            <Space wrap>
              {
                isPermission(authPermission, 'PaceProgramRates Update') &&

                <Button type="primary" icon={<EditOutlined />} onClick={() => handleUpdate(record)} />

              }
              {
                isPermission(authPermission, 'PaceProgramRates Delete') &&
                <Popconfirm
  ...
  return (
    <>
      <Banner
        ...
        breadCrumb={[
          { title: "Home", path: "/" },
          { title: "Pace Program Rate" },
        ]}
        buttonTitle={'Create'}
        buttonUrl={addNew}
        // onExport={() => console.log("Export Clicked")}
        permission={'PaceProgramRates Create'}
      />
      <Card>
        <AdvanceTable
          data={data}
          ...
          onDelete={isPermission(authPermission, 'Pace Program Rates Delete') ? onDelete : ''}
        />
        <Popup {...popupProps} />
      </Card>
    </>
...
export default PaceProgramRate;
